...
export function MissionControlModal({
  ...
  return (
    <>
      ...
      <div
        className="mission-control-shell fixed inset-8 flex flex-col overflow-hidden pixel-panel"
        style={{ zIndex: 31 }}
        ...
        <div className="flex-1 min-h-0 min-w-0 overflow-hidden">
          ...
          {activeView === 'agent' ? (
            <AgentInspectorDrawer
              ...
              missionControl={missionControl}
              embeddedTerminal={
                selectedSession !== null ? embeddedTerminals[selectedSession] : undefined
              }
            />
          ) : null}
        </div>
